...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/docs/surat_abk.css') }}">
...
<body class="p-5">
    <div class="row">
        <div class="col-2">
            <img src="{{ asset('assets/images/docs/Metro Jaya.png') }}" alt="">
        </div>
        <div class="col-8">
    ...
    <div class="detail-direktur mt-5">

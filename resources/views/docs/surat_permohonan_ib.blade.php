    ...
    <style>
        ...
        *,
        ...
        .btn-success {
            ...
            --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
            --bs-btn-disabled-color: #fff;
            --bs-btn-disabled-bg: #00b579;
            --bs-btn-disabled-border-color: #00b579;
        }
        ...
        .btn-outline-success {
            ...
            --bs-btn-border-color: #00b579;
            --bs-btn-hover-color: #fff;
            --bs-btn-hover-bg: #00b579;
            --bs-btn-hover-border-color: #00b579;
            --bs-btn-focus-shadow-rgb: 25, 135, 84;
            --bs-btn-active-color: #fff;
            --bs-btn-active-bg: #00b579;
            --bs-btn-active-border-color: #00b579;
            --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
            --bs-btn-disabled-color: #00b579;
            --bs-btn-disabled-bg: transparent;
            --bs-btn-disabled-border-color: #00b579;
            --bs-gradient: none;
        }
    ...
    <div class="title-div mt-4">
        <div class="row">
            ...
            <div class="col-4">
                ...
                <span>di_</span><br>
                <span style="margin-left: 20px">Metro</span><br>
            </div>
        </div>
    </div>
